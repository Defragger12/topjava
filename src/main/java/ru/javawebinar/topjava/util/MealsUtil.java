...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static Meal createNewFromTo(MealTo mealTo) {
        return new Meal(null, LocalDateTime.parse(mealTo.getDateTime()), mealTo.getDescription(), mealTo.getCalories());
    }

    public static MealTo asTo(Meal meal) {
        return new MealTo(meal.getId(), meal.getDateTime().toString(), meal.getDescription(), meal.getCalories());
    }

    public static Meal updateFromTo(Meal meal, MealTo mealTo) {
        meal.setDateTime(LocalDateTime.parse(mealTo.getDateTime()));
