...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    @Override
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int mealId) {
        String start = DateTimeUtil.toStringWithSS(startDate);
        String end = DateTimeUtil.toStringWithSS(endDate);

        return jdbcTemplate.query("SELECT * FROM meals WHERE dateTime BETWEEN '" + start + "' AND '" + end + "'", ROW_MAPPER);
